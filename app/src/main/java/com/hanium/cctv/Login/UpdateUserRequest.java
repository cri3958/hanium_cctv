...
public class UpdateUserRequest extends StringRequest {
    ...
    //public UpdateUserRequest(String mem_id, String mem_name, String mem_phone, String mem_emergency, String mem_imagedata, Response.Listener<String> listener) {
    public UpdateUserRequest(String mem_id, String mem_name, String mem_phone, String mem_emergency, Response.Listener<String> listener) {
